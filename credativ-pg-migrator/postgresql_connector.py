...
class PostgreSQLConnector(DatabaseConnector):
    ...
    def get_create_table_sql(self, settings):
        ...
        for _, column_info in converted.items():
            ...
            if column_info['column_default'] or column_info['replaced_column_default']:
                column_default = column_info['column_default']
                if column_info['replaced_column_default']:
                    column_default = column_info['replaced_column_default']
