...
- 2025.06.19:
  ...
  - Started implementation of premigration analysis of the source databases - in this step code takes only basic information and only values readily available in the source database - we will standardize returned structures for all connectors later
