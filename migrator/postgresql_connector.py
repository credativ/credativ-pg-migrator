        ...
        for _, column_info in converted.items():
            ...
            if column_info['column_default']:
                if (('CHAR' in column_data_type or column_data_type in ('TEXT'))
                    and ('||' in column_info['column_default'] or '(' in column_info['column_default'] or ')' in column_info['column_default'])):
                    create_column_sql += f""" DEFAULT {column_info['column_default']}""".replace("''", "'")
                elif 'CHAR' in column_data_type or column_data_type in ('TEXT'):
                    create_column_sql += f""" DEFAULT '{column_info['column_default']}'""".replace("''", "'")
                elif column_data_type in ('BOOLEAN', 'BIT'):
                    create_column_sql += f""" DEFAULT {column_info['column_default']}::BOOLEAN"""
                else:
                    create_column_sql += f" DEFAULT {column_info['column_default']}"
