...
- 2026.07.29
  ...
  - Feature - Connectors / Base Database Connector: Added automatic stripping of MySQL/MariaDB character set and collation specifications (`CHARACTER SET <charset>`, `CHARSET <charset>`, `COLLATE <collation>`) when converting SQL code, views, functions, and expressions for target PostgreSQL. Prevents `syntax error at or near "character"` errors in PostgreSQL view creation (e.g. column definitions carrying `character set utf8mb4`).
