...
Planned features:
- Reading the partitioning of the remaining sources: the Db2 family, Informix, MS SQL Server,
  Sybase ASE and MySQL/MariaDB. The order and the reason for each place are in
