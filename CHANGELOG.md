...
- 2025.10.06:
  ...
  - Fixes is UNL to CSV conversion - improved handling of escaped delimiters in text values, repaired processing of text values with multiple lines with the first line containing only new line character
