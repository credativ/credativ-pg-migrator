...
Planned features:
- Reading the partitioning of MS SQL Server, the last of the twelve sources. The order and the
  reason for each place are in `development/PARTITIONING_STRATEGY.md` §2.4.
