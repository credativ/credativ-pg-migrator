...
Planned features:
- Reading the partitioning of the remaining sources: MS SQL Server, Sybase ASE and
  MySQL/MariaDB. The order and the reason for each place are in
  `development/PARTITIONING_STRATEGY.md` §2.4.
