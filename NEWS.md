...
* Fixed SQL Anywhere column default values and view transpilation by populating `get_sql_functions_mapping` for SQL Anywhere date/time keywords (`current date`, `current timestamp`), identity default expressions, and string functions
